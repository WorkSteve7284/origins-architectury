...
public record GuiTitle(@Nullable Component view, @Nullable Component choose) {
	...
	public static final Codec<GuiTitle> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			CalioCodecHelper.COMPONENT_CODEC.optionalFieldOf("view_origin").forGetter(OptionalFuncs.opt(GuiTitle::view)),
			CalioCodecHelper.COMPONENT_CODEC.optionalFieldOf("choose_origin").forGetter(OptionalFuncs.opt(GuiTitle::choose))
